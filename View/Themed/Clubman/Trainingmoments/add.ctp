<!-- app/View/Trainingmoments/add.ctp -->
<h2>Nieuw trainingsmoment</h2>
<script>
	...
	<div class="col-xs-12">
		...
		<div class="panel panel-info">
		  ...
		  <div class="panel-body">
				<p>
					Vergeet onderaan niet op "Voeg trainingsmoment toe" te klikken!
				</p>
		  </div>
		</div>

		<div class="trainingmoments form">
			<h4>Voeg een trainingsmoment toe</h4>
			...
			<div class="form-group">
				<div class="col-sm-offset-3 col-sm-6">
					<?= $this->Form->button(__('Voeg trainingsmoment toe'), array('class' => 'btn btn-default', 'type' => 'submit'))?>
				</div>
			</div>
			<?=$this->Form->end()?>
