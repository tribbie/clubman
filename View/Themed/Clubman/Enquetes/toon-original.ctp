<?php
	echo "<h1>Formulier van " . $enquete['Enquete']['algemeen_naam'] . "</h1>\n";

	echo "<br/>\n";
	echo $this->Html->link("terug naar de lijst", array('action' => 'lijst')) . "\n";
	echo "<br/>\n";
...
//	echo "<tr><td><strong>Volgend seizoen</strong></td><td><strong>" . $enquete['Enquete']['algemeen_volgendseizoen'] . "</strong></td></tr>\n"; 
	...
	echo "<tr><td><strong>Do#1</strong></td><td>" . $enquete['Enquete']['training_do19302130'] . "</td></tr>\n"; 
	echo "<tr><td><strong>Vr#1</strong></td><td>" . $enquete['Enquete']['training_vr17451915'] . "</td></tr>\n"; 
	echo "<tr><td><strong>Vr#2</strong></td><td>" . $enquete['Enquete']['training_vr19152100'] . "</td></tr>\n"; 
...
//	echo "<tr><td colspan='2'><font size='+1' color='#0000f0'>-. volleytoekomst</font></td></tr>\n";
//	echo "<tr><td><strong>Toekomst</strong></td><td>" . $enquete['Enquete']['volley_toekomst'] . "</td></tr>\n";

	echo "<tr><td colspan='2'><font size='+1' color='#0000f0'>8. diversen</font></td></tr>\n";
