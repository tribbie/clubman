<!-- app/View/Elements/enquete-2015-form.ctp -->
...
<?= $this->Form->input('algemeen_volgendseizoenploeg', array('label' => 'Je eerst keus qua ploeg ...', 'type' => 'select', 'options' => array('' => '', 'bengels' => 'Bengels', 'U11' => 'U11', 'U13' => 'U13', 'U15' => 'U15', 'U17' => 'U17', 'U19' => 'U19', 'seniors' => 'Dames / Heren'))); ?>
...
<span class='valop'>(je mag gerust in sectie 8 invullen wat je nog kwijt wil)</span>.<br/>
...
<ul>
	<li><strong>Redacteurs & redactrices voor ons Passeurke:</strong><br/>Ons goed gelezen clubblad heeft nood aan creatievellingen. Jullie zorgen er maandelijks voor dat wij een mooi, plezierig en tof boekje in onze mailbox krijgen. Voel je je aangesproken? Niet twijfelen dan.</li>
	<li><strong>Train(st)er:</strong><br/>Gezien het groeiend aantal jonge, enthousiaste volleyballertjes binnen onze club, zijn nieuwe train(st)ers steeds welkom! Ons huidig trainerscorps zal hun zeker wegwijs maken in het reilen en zeilen van VCW.</li>
	<li><strong>Assistent-train(st)er:</strong><br/>Het is vanzelfsprekend dat onze trainers, met groepen van 10 tot 30 kinderen, assistent-trainers met plezier zien komen. Voel je je geroepen om onze kinderen mee te begeleiden, aarzel dan niet ons dit te melden!</li>
	<li><strong>Scheidsrechter:</strong><br/>Indien je bereid bent om af en toe een thuiswedstrijd te leiden, kunnen wij dit enkel toejuichen, dus laat het ons vooral weten. Wederom kan je rekenen op een voorafgaande uitleg/opleiding indien nodig.</li>
<!--	<li><strong>VIS-coördinator:</strong><br/>Er is iemand nodig die vol enthousiasme zorgt voor onze gouden medailles op de VIS-demotornooien. Hij/zij is de motor achter het hele gebeuren en zorgt voor de uitnodigingen, het motiveren van spelers en trainers om te komen, de tijdige officiële inschrijving en op de dag zelf voor het superviseren dat alles vlot verloopt met onze VCW-ertjes. Het spreekt vanzelf dat uitgebreide hulp in het begin beschikbaar zal zijn!</li> -->
<!--	<li><strong>Jeugdcoördinator</strong><br/>Wil je de spil worden van het jeugdgebeuren aarzel dan niet ons te contacteren. Wij geven graag een woordje extra uitleg.</li> -->
<!--	<li><strong>Jeugdsecretaris</strong><br/>Je helpt de cel jeugd met het administratieve reilen en zeilen van alles wat onze toekomstige talentjes aan belangt.</li> -->
<!--	<li><strong>Sponsorverantwoordelijke</strong><br/>Tja zonder deze toponderhandelaar zouden wij van het volleybal bij VCW een minder democratiche sport moeten maken. Ben jij iemand die graag eens binnenspringt bij de lokale handel, dan is dit echt iets voor jou.</li> -->
<!--	<li><strong>Voorzitter</strong><br/>Den baas zoals ze zeggen. Je bent de persoon die helpt onze club op organisatorisch en financieel vlak op het goede spoor te houden. Van het sportieve hoef je je geen zorgen te maken.</li> -->
</ul>
<br/>
...
<?= $this->Form->input('organisatie_taak', array('label' => 'En wel deze taak', 'type' => 'select', 'options' => array('' => '', 'redactie' => 'Redactie boekje "Passeurke"', 'trainer' => 'Train(st)er', 'assistent-trainer' => 'Assistent-train(st)er', 'scheidsrechter' => 'Scheidsrechter'))); ?>
