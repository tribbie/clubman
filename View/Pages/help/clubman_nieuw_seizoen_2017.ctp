...
<pre>
  ALTER TABLE cm_games AUTO_INCREMENT                      = 17000001;
  ALTER TABLE cm_gamesteammembers AUTO_INCREMENT           = 17000001;
  ALTER TABLE cm_teammembers AUTO_INCREMENT                = 17000001;
  ALTER TABLE cm_teams AUTO_INCREMENT                      = 17000001;
  ALTER TABLE cm_trainingmomentsteammembers AUTO_INCREMENT = 17000001;
  ALTER TABLE cm_trainingmomentsteams AUTO_INCREMENT       = 17000001;
  ALTER TABLE cm_trainings AUTO_INCREMENT                  = 17000001;
  ALTER TABLE cm_trainingsteammembers AUTO_INCREMENT       = 17000001;
  # bijkomend ook best ...
  ALTER TABLE cm_mails AUTO_INCREMENT     = 17000001;
  ALTER TABLE cm_efforts AUTO_INCREMENT   = 17000001;
  ALTER TABLE cm_meterings AUTO_INCREMENT = 17000001;
  ALTER TABLE cm_pictures AUTO_INCREMENT  = 17000001;
  ALTER TABLE cm_uploads AUTO_INCREMENT   = 17000001;
</pre>
<br/>
...
<hr/>
<h3># Resetten lidgeld kampgeld (naar 0) en betaaldatums (naar NULL).</h3>
