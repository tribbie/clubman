...
<h3>Procedure mailing enquete 2019 - CLUBMAN</h3>
...
<div class="panel panel-info">
  ...
  <ul class="list-group">
    <li class="list-group-item">
      ...
      <ul>
        <li>
          ...
          In 2019 toegevoegd (of een voorbeeld als er niets is toegevoegd):<br/>
          <code>
    ...
    <li class="list-group-item">
      ...
      <ul>
        <li>
          file Elements/enquete-2018-2019-view.ctp
        </li>
        <li>
          file Elements/enquete-2018-2019-form.ctp
          <ul>
            <li>ten laatste antwoord tegen xx maand 2019</li>
            <li>Wedstrijden: 18 jaar op 1/01/2020 ipv 1/1/2019</li>
