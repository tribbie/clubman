<!--
<h1>Enquête afgelopen</h1>
<br/>

<div class='attention'>
De ledenbevraging is afgelopen.<br/>
...
Hoi,<br/>
<br/>
In het kader van onze voorbereiding van het seizoen 2014-2015 vind je hieronder een beknopte vragenlijst.<br/>
...
<br/>
Graag hadden we de ingevulde vragenlijst terug ten laatste op <strong>28 februari 2014</strong>.<br/>
<br/>
...
//	echo $this->Form->input('algemeen_volgendseizoen', array('label' => 'Volgend seizoen ...', 'type' => 'select', 'options' => array('' => '', 'VCW' => '... blijf ik natuurlijk bij VCW', 'stop' => '... stop ik', 'elders' => '... ga ik naar een andere club'))); 
	...
	echo $this->Form->input('training_vr17451915', array('label' => 'vr 17:45-19:15', 'type' => 'select', 'options' => array('' => '', 'ja' => 'ja', 'eventueel' => 'eventueel', 'nee' => 'nee'))); 
	echo $this->Form->input('training_vr19152100', array('label' => 'vr 19:15-21:00', 'type' => 'select', 'options' => array('' => '', 'ja' => 'ja', 'eventueel' => 'eventueel', 'nee' => 'nee'))); 
	...
	echo "<h3>Locatie</h3>\n";
	echo "Hoever wil jij rijden voor extra trainingszalen en uren en eventuele samenwerking met andere volleybalclubs.<br/>\n";
	echo $this->Form->input('locatie_elders', array('label' => 'Extra afstand', 'type' => 'select', 'options' => array('niet verder' => 'Niet verder dan nu', '0-15min' => '0 - 15 minuten', '15-20min' => '15 - 20 minuten'))); 
...
Indien je nog in aanmerking komt voor jeugdvolleybal (18 jaar op 1/1/2014) en om iedereen zoveel mogelijk speelkansen te geven, bestaat er de mogelijkheid om in bepaalde omstandigheden 2 wedstrijden per weekend te spelen.<br/>
Wil jij dit doen?<br/>
...
<?php
	echo $this->Form->input('diversen_tekst', array('label' => 'Het volgende wil ik nog kwijt', 'rows' => '15'));
