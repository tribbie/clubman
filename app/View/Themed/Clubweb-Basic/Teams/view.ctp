...
<?php if (isset($team['Team'])) : ?>
	...
	<div class="row">
		...
		<div class="col-md-6">
			...
			<?php if ((strtolower($team['Team']['category']) == 'bestuur') or (strtolower($team['Team']['category']) == 'onbekend')) : ?>
		...
		<?php if ((strtolower($team['Team']['category']) <> 'bestuur') and (strtolower($team['Team']['category']) <> 'onbekend')) : ?>
			<div class="col-xs-12">
...
<?php else : ?>
	<div class="row">
		<div class="col-md-6">
			...
			<div class='blockview teamview' id='noteam'>
				<?= $this->Html->image('cmstyle/team_placeholder.png', array('title' => 'no image', 'class' => 'img-responsive img-rounded center-block', 'width' => '100%')); ?>
			</div>
